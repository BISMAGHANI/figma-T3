  ...
  return (
    <div className='flex flex-col items-center'>
        ...
        <div className="flex px-4 py-3 rounded-md w-[30%] border-2 border-text-secondary-gray mt-4 justify-between">
            <input className=" bg-white focus-visible:outline-none w-[64%]" type="text" placeholder="What can we help you with?" name="" id="" />
            <Image src={searchIcon} alt="wishlist" width={30} />
        </div>
        <div className="grid grid-cols-12 px-8 md:px-16 py-8 bg-white text-gray-800">
            <div className='col-span-9 border-r-[1.3px] pr-4 border-text-secondary-gray'>
                ...
                <div className='flex mt-4 gap-4'>
                    <button  className="rounded-full py-2 text-white hover:btn-success">Join Us</button>
                    <button  className="rounded-full py-2 text-white hover:btn-success">Shop Nike</button>
                </div>
                <div>
