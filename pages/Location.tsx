...
import Nav from "../src/app/components/Navbar";
      ...
      <section className="flex flex-col lg:flex-row w-full h-full items-center p-5">
        ...
        <div className="bg-white w-full lg:w-[40%] xl:w-[40%] p-10 overflow-y-auto">
          <div className="flex flex-col gap-5">
            ...
            {/* Search Input */}
            <div className="flex w-full p-2 gap-3 items-center border rounded bg-white">
              <SlMagnifier />
              <input
                type="search"
                id="search"
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <button className="rounded-full flex items-center gap-2 btn btn-dard hover:btn-success">
                <span>Filter</span>
                <IoFilterSharp />
              </button>
            </div>
